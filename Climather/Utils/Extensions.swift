...
//  Climather
//
//  Created by Amarjeet Kumar on 01/02/24.
//
...
extension Color{
    ...
    static let weatherEidgetBackground =  LinearGradient(gradient:  Gradient(colors: [Color("Weather Widget Background 1"), Color("Weather Widget Background 2")]), startPoint: .leading, endPoint: .trailing)
    ...
    static let underline =  LinearGradient(gradient:  Gradient(colors: [.white.opacity(0), .white.opacity(0)]), startPoint: .leading, endPoint: .trailing)
